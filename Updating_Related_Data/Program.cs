...
namespace Updating_Related_Data
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ApplicationDbContext2 context = new();
            ...
            // --> Burada bir nevi Update fonksiyonuyla yapacagimiz isi iliskiler uzerinden uzun bir sekilde yapmis olduk
            ...
            // --> Asagidaki gibi bir guncelleme yaparsak primary key degistirmeye calistigimizdan sistem hata verecektir. O yuzden once silip sonra ekleme yapmaliyiz
            //Address? address = await context.Addresses.FindAsync(1);
            //address.Id = 2;
            //await context.SaveChangesAsync();

            // --> 1. Yontem, Var olan Personla iliskilendirme
            //Address? address = await context.Addresses.FindAsync(1);
            ...
            // --> 2. Yontem, Yeni bir Personla iliskilendirme
            ...
            // --> 1. Kitaba 3. Yazari Ekleme Islemi
            ...
            // --> 3 Id li yazar Sadece 1 Id li kitab ile iliskili olsun istiyoruz
            ...
            // --> Book Id 'si 2 olan entity'den 1 Id li Author'u silelim 3 Id li Author ile iliskilendirelim ve 4. Author'u ekleyelim
        ...
        public class ApplicationDbContext2 : DbContext
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=.\SQLEXPRESS;Database=ApplicationDbContext2;User Id=sa;Password=prostreet273;TrustServerCertificate=True");
            }
